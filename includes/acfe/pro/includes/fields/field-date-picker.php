...
class acfe_field_date_picker
{
    ...
    public function date_render_field_settings($field)
    {
    ...
    public function date_field_wrapper_attributes($wrapper, $field)
    {
    ...
    public function date_time_render_field_settings($field)
    {
        acf_render_field_setting($field, array(
            'label'         => __('Placeholder', 'acf'),
            'name'          => 'placeholder',
    ...
    public function date_time_field_wrapper_attributes($wrapper, $field)
    {
    ...
    public function time_render_field_settings($field)
    {
        acf_render_field_setting($field, array(
            'label'         => __('Placeholder', 'acf'),
            'name'          => 'placeholder',
    ...
    public function time_field_wrapper_attributes($wrapper, $field)
    {
