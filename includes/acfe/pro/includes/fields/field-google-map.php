...
class acfe_field_google_map
{
    ...
    public function prepare_zoom($field)
    {
    ...
    public function field_group_settings_before($field)
    {
    ...
    public function field_group_settings($field)
    {
        $zoom = acf_maybe_get($field, 'zoom');
    ...
    public function field_group_wrapper($wrapper, $field)
    {
