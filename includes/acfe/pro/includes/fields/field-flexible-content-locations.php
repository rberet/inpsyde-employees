...
class acfe_field_flexible_content_layout_locations
{
    ...
    public function update_field($field)
    {
        ...
        foreach ($field['layouts'] as &$layout) {
            ...
            // validate
            if (!acf_maybe_get($layout, 'acfe_layout_locations')) {
                continue;
            }
    ...
    public function prepare_field($field)
    {
        ...
        foreach ($field['layouts'] as $i => $layout) {
            ...
            // get visibility
            if ($this->get_visibility($layout, $args)) {
                continue;
            }
    ...
    public function get_visibility($layout, $args)
    {
    ...
    public function render_location_group($layout, $l_prefix)
    {
    ...
    public function render_location_rule($rule, $prefix)
    {
        ?>
