...
class acfe_field_relationship
{
    ...
    public function field_wrapper($wrapper, $field)
    {
    ...
    public function render($field)
    {
        ...
        */
        ...
        foreach ($post_types as $post_type => $label) {
                    ...
                    // button
            $button = array();
            $button['href'] = $this->get_add_new_button_href($post_type); ?><li><a <?php echo acf_esc_attrs($button); ?>><?php echo $label; ?></a></li><?php
        } ?></ul>
        </script>
        <?php
    }
    
    public function get_add_new_button_href($post_type)
    {
    ...
    public function relationship_ajax()
    {
