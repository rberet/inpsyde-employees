...
class acfe_field_wysiwyg
{
     ...
     * Source Code iFrame
     */
    public function source_code_iframe()
    {
        ...
        wp_enqueue_style('code-editor'); ?><!DOCTYPE html>
        <html lang="en-US">
     ...
     */
    public function mce_init($init, $editor_id)
    {
     ...
     */
    public function mce_settings($settings)
    {
     ...
     * Prepare Toolsbars
     */
    public function prepare_toolbars()
    {
