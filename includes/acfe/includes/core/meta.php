...
class ACFE_Local_Meta
{
    ...
    // Vars
    public $meta = array();
    public $curr_id = array();
    public $main_id = array();
     ...
     * Add
     */
    public function add($meta = array(), $post_id = 0, $is_main = false)
    {
     ...
     * Is Request
     */
    public function is_request($meta = array())
    {
     ...
     * Capture
     */
    public function capture($values = array(), $post_id = 0)
    {
