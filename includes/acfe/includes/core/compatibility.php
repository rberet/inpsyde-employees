...
class acfe_compatibility
{
     ...
     */
    public function field_acfe_update($field)
    {
     ...
     */
    public function acfe_form_import_compatibility($args, $name, $post_id)
    {
     ...
     */
    public function pto_acf_field_group($ignore, $orderby, $query)
    {
