...
class acfe_field_flexible_content_controls
{
    ...
    public function action_wrapper($wrapper, $field)
    {
    ...
    public function action_button($button, $field)
    {
        if (!$field['acfe_flexible_stylised_button']) {
    ...
    public function action_button_secondary($button, $field)
    {
        if (!$field['acfe_flexible_stylised_button']) {
            $button['class'] .= ' button-primary';
        }
    ...
    public function no_value_message($message, $field)
    {
