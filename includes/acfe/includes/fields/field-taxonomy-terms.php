...
class acfe_field_taxonomy_terms extends acf_field
{
    ...
    public function ajax_query_allowed_terms()
    {
    ...
    public function get_ajax_query_allowed_terms($options = array())
    {
    ...
    public function get_terms($field, $args = array())
    {
    ...
    public function filter_terms($all_terms, $field)
    {
    ...
    public function convert_terms_to_choices($terms = array())
    {
        $choices = array();
