...
class acfe_field_flexible_content_edit
{
    ...
    public function render_layout_settings($field, $layout, $prefix)
    {
    ...
    public function validate_edit($field)
    {
    ...
    public function pre_render_layout($layout, $field, $i, $value, $prefix)
    {
    ...
    public function render_layout($layout, $field, $i, $value, $prefix)
    {
        if (empty($layout['sub_fields']) || !$field['acfe_flexible_modal_edit']['acfe_flexible_modal_edit_enabled']) {
            return;
        } ?>
    ...
    public function layout_div($div, $layout, $field)
    {
        if (!$field['acfe_flexible_modal_edit']['acfe_flexible_modal_edit_enabled']) {
            return $div;
        }
    ...
    public function layout_handle($handle, $layout, $field)
    {
        if (!$field['acfe_flexible_modal_edit']['acfe_flexible_modal_edit_enabled']) {
            return $handle;
        }
