...
class acfe_field_checkbox
{
    ...
    public function prepare_field_group_choices($field)
    {
    ...
    public function prepare_checkbox($field)
    {
    ...
    public function walk($choices = array(), $depth = 1, $labels = array())
    {
    ...
    public function prepare_radio($field)
    {
