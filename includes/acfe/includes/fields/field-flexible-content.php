...
class acfe_field_flexible_content
{
     ...
     */
    public function render_field_layouts_settings_label($field)
    {
     ...
     *  Layout Settings
     */
    public function render_field_layouts_settings($field)
    {
     ...
     *  Render Layout Fields
     */
    public function render_layout_fields($layout, $field, $i, $value, $prefix)
    {
     ...
     */
    public function prepare_layout_editor($field)
    {
        $field['delay'] = 1;
        return $field;
    }
