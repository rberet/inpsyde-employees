...
{
    public $allowed_types = array('relationship', 'post_object', 'user', 'taxonomy');
     ...
     * Field Settings
     */
    public function field_settings_render($field)
    {
     ...
     */
    public function ajax_results($options = array())
    {
     ...
     */
    public function get_related_settings($r_field, $r_field_group, &$choices)
    {
     ...
     */
    public function field_settings_default_value($field)
    {
     ...
     */
    public function field_settings_update($field)
    {
     ...
     */
    public function field_settings_delete($field)
    {
     ...
     */
    public function relationship($type, $r_id, $p_field, $p_value)
    {
    ...
    public function get_value_from_ancestor($r_ref_values, $r_field)
    {
    ...
    public function is_field_bidirectional($field)
    {
    ...
    public function has_field_bidirectional($field)
    {
    ...
    public function get_field_bidirectional($field)
    {
