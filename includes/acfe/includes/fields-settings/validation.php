...
class acfe_field_validation
{
    ...
    public function get_user_by_slug($value)
    {
        return get_user_by('slug', $value);
    }

    public function get_user_by_email($value)
    {
    ...
    public function get_post_by_id($value)
    {
    ...
    public function get_post_by_title($value)
    {
        $get_posts = get_posts(array(
            's'                 => $value,
            'post_type'         => 'any',
