...
class acfe_form_custom
{
    ...
    public function validate_action($valid, $value, $field, $input)
    {
        if (!$valid) {
            return $valid;
        }
    ...
    public function advanced_validation($field)
    {
...
function my_form_custom_action_validation($form, $post_id, $alias){
    ...
    public function advanced_submit($field)
    {
        $form_name = get_field('acfe_form_name', acfe_get_post_id());
        if (empty($form_name)) {
            $form_name = 'my_form';
...
function my_form_custom_action($form, $post_id){
    ...
    public function add_action($layouts)
    {
