...
class acfe_dev
{
    ...
    public function edit_post($post_type, $post)
    {
     ...
     * Admin
     */
    public function load_options($page)
    {
     ...
     * Add Meta Boxes
     */
    public function add_meta_boxes($post_id, $object_type)
    {
    ...
    public function render_meta_value($value)
    {
        $return = '';
    ...
    public function ajax_bulk_delete_meta()
    {
