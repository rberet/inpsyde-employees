...
class acfe_enhanced_ui
{
     ...
     * Term: Add Metaboxes
     */
    public function term_add_metaboxes($term, $taxonomy)
    {
     ...
     * Term: Do Metaboxes
     */
    public function term_do_metaboxes_top($term, $taxonomy)
    {
     ...
     * Term: Do Metaboxes
     */
    public function term_do_metaboxes($term, $taxonomy)
    {
     ...
     * Term: Footer List
     */
    public function term_footer_list()
    {
        global $tax;
     ...
     * Term: Footer Edit
     */
    public function term_footer_edit()
    {
        global $tag, $tax; ?>
        <div class="permalink">
     ...
     * User: Screen Edit
     */
    public function user_screen_edit($user)
    {
     ...
     * User: Screen New
     */
    public function user_screen_new()
    {
     ...
     * User: Add Metaboxes
     */
    public function user_add_metaboxes($args = array())
    {
     ...
     * User: Do Metaboxes
     */
    public function user_do_metaboxes($user)
    {
     ...
     * User: Footer New
     */
    public function user_footer_new()
    {
        ?>
        <script type="text/javascript">
        (function($){
     ...
     * User: Footer Edit
     */
    public function user_footer_edit()
    {
        global $profileuser; ?>
        <div id="edit-slug-box">
     ...
     */
    public function settings_add_metaboxes()
    {
     ...
     */
    public function settings_do_metaboxes()
    {
     ...
     */
    public function add_metaboxes($field_groups, $post_id, $screen)
    {
        $postboxes = array();
     ...
     */
    public function render_metabox_submit($post, $metabox)
    {
        ?>
        <div class="submitbox">
