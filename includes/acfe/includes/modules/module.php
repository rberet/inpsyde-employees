...
class acfe_dynamic_module
{
     ...
     * Current Screen
     */
    public function _current_screen()
    {
        $this->current_screen();
     ...
     * Post Submit Box
     */
    public function _post_submitbox_misc_actions($post)
    {
     ...
     */
    public function post_enter_title_here($placeholder, $post)
    {
        return $this->label;
    }
     ...
     * Edit Row Actions
     */
    public function _edit_row_actions($actions, $post)
    {
     ...
     * Trashed Post Type
     */
    public function _trashed_post($post_id)
    {
     ...
     * Untrashed Post Type
     */
    public function _untrashed_post($post_id)
    {
        if (get_post_type($post_id) !== $this->post_type) {
            return;
        }
     ...
     * Exclude Post Type
     */
    public function get_post_types($post_types, $args)
    {
        if (empty($post_types)) {
            return $post_types;
        }
     ...
     */
    public function get_fields_labels_recursive(&$array, $field)
    {
        $label = '';
