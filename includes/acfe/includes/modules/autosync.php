...
class ACFE_AutoSync
{
     ...
     * Override: Json
     */
    public function override_json($value)
    {
     ...
     * Override: Json Save
     */
    public function override_json_save($path)
    {
     ...
     * Override: Json Load
     */
    public function override_json_load($paths)
    {
     ...
     * Json: Scan
     */
    public function scan_json_folders()
    {
     ...
     */
    public function scan_json_folders_compatibility()
    {
        $json_files = array();
     ...
     * PHP: Scan
     */
    public function scan_php_folders()
    {
        $php_files = array();
     ...
     */
    public function pre_update_field_group_json($field_group)
    {
        if (!$this->is_json_enabled()) {
            return;
        }
     ...
     */
    public function post_update_field_group_json($field_group)
    {
        if (!$this->is_json_enabled()) {
            return;
        }
