...
class acfe_dynamic_forms_cheatsheet
{
    ...
    public function query_var($field)
    {
        ?>
        <table class="acf-table">
            <tbody>
    ...
    public function actions_post($field)
    {
        ?>
        <table class="acf-table">
            <thead>
    ...
    public function actions_term($field)
    {
        ?>
        <table class="acf-table">
            <thead>
    ...
    public function actions_user($field)
    {
        ?>
        <table class="acf-table">
            <thead>
    ...
    public function actions_email($field)
    {
        ?>
        <table class="acf-table">
            <thead>
    ...
    public function current_post($field)
    {
        ?>
        <table class="acf-table">
            <tbody>
    ...
    public function current_term($field)
    {
        ?>
        <table class="acf-table">
            <tbody>
    ...
    public function current_user($field)
    {
        ?>
        <table class="acf-table">
            <tbody>
    ...
    public function current_author($field)
    {
        ?>
        <table class="acf-table">
            <tbody>
    ...
    public function current_form($field)
    {
        ?>
        <table class="acf-table">
            <tbody>
