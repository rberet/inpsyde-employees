...
class acfe_dynamic_forms_hooks
{
    ...
    public function prepare_custom_html($value, $post_id, $field)
    {
    ...
    public function prepare_actions($field)
    {
     ...
     */
    public function field_groups_choices($field)
    {
    ...
    public function form_return_deprecated($field)
    {
    ...
    public function format_value_post_object($value, $_value, $post_id, $field)
    {
    ...
    // User
    public function format_value_user($value, $_value, $post_id, $field)
    {
        $value = acf_get_array($_value);
        $array = array();
    ...
    // Taxonomy
    public function format_value_taxonomy($value, $_value, $post_id, $field)
    {
        $value = acf_get_array($_value);
        $array = array();
    ...
    // Image / File
    public function format_value_file($value, $_value, $post_id, $field)
    {
        $value = acf_get_array($_value);
        $array = array();
    ...
    public function format_value_select($value, $_value, $post_id, $field)
    {
        $value = acf_get_array($_value);
        $array = array();
    ...
    // Google Map
    public function format_value_google_map($value, $_value, $post_id, $field)
    {
        if (is_string($value)) {
