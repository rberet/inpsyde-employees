...
class acfe_single_meta
{
     ...
     * Preload Meta
     */
    public function pre_load_meta($return, $post_id)
    {
     ...
     * Load Metadata
     */
    public function pre_load_metadata($return, $post_id, $name, $hidden)
    {
        if ($name === 'acf') {
            return $return;
        }
     ...
     * Update Metadata
     */
    public function pre_update_metadata($return, $post_id, $name, $value, $hidden)
    {
        if ($name === 'acf') {
            return $return;
        }
     ...
     * Delete Metadata
     */
    public function pre_delete_metadata($return, $post_id, $name, $hidden)
    {
    ...
    public function get_store($post_id)
    {
    ...
    public function update_meta($name, $value, $post_id)
    {
     ...
     * Field Setting
     */
    public function field_setting($field)
    {
    ...
    */
     ...
     * Revision Pre Update
     */
    public function revision_pre_update($null, $post_id, $name, $value, $hidden)
    {
     ...
     * Revision Field (acf)
     */
    public function revision_field($value, $field_name, $post = null, $direction = false)
    {
