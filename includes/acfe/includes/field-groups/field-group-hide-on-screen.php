...
class acfe_field_group_hide_on_screen
{
     ...
     */
    public function prepare_hide_on_screen($field)
    {
        $choices = array();
     ...
     */
    public function acf_add_meta_boxes($post_type, $post, $field_groups)
    {
     ...
     */
    public function ajax_check_screen()
    {
     ...
     * Hide Block Editor
     */
    public function hide_block_editor()
    {
