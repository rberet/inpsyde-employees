...
class acfe_field_group_category
{
     ...
     */
    public function column_html($column, $post_id)
    {
     ...
     */
    public function acf_get_taxonomies($taxonomies, $args)
    {
        if (empty($taxonomies)) {
            return $taxonomies;
        }
     ...
     * Prepare Export
     */
    public function prepare_for_export($field_group)
    {
     ...
     * Prepare Import
     */
    public function prepare_for_import($field_group)
    {
