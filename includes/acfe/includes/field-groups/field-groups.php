...
class ACFE_Field_Groups
{
     ...
     * Table Columns HTML
     */
    public function table_columns_html($column, $post_id)
    {
    ...
    public function render_table_column($column, $field_group)
    {
        switch ($column) {
     ...
     * Column: Source
     */
    public function render_admin_table_column_source_html($field_group)
    {
     ...
     * Column: Load
     */
    public function render_admin_table_column_load_html($field_group)
    {
     ...
     */
    public function render_admin_table_column_php_html($field_group)
    {
    ...
    public function get_php_data($field_group)
    {
        $return = array(
            'message' => false,
            'file' => false,
     ...
     */
    public function render_admin_table_column_json_html($field_group)
    {
    ...
    public function get_json_data($field_group)
    {
        $return = array(
            'message' => false,
            'file' => false,
     ...
     */
    public function get_human_readable_file_location($file, $found = true, $br = true, $prefix = true)
    {
     ...
     * Seamless Metabox
     */
    public function seamless_metabox($post_type, $post, $field_groups)
    {
    ...
    public function get_sync_compatibility()
    {
        $sync = array();
